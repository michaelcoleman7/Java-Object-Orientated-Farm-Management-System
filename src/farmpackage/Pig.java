...
//Pig class extends the Animal class via inheritance
public final class Pig extends Animal {
	...
	public Pig(String[] array) {
		super(array);
		this.breed = array[2];
		this.colour = array[3];
	}
	
	//This returns the breed of the Pig.
	public String getBreed() {
		return breed;
	}

	//This sets the breed of the Pig.
	public void setBreed(String breed) {
		this.breed = breed;
	}

	//This returns the colour of the Pig.
	public String getColour() {
		return colour;
	}

	//This sets the colour of the Pig.
	public void setColour(String colour) {
		this.colour = colour;
	}
	
	//This overrides the default toString() method to display the Breed and colour of Pig.
	@Override
